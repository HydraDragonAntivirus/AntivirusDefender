rule INDICATOR_SUSPICIOUS_FAN_MADE_MALWARE {
    ...
    strings:
        ...
        $h15 = "Hacked" ascii wide nocase
        $h16 = "gdi32dll" ascii wide nocase
        $h17 = "onion" ascii wide nocase
        $h18 = "attention" ascii wide nocase
        $h19 = "efi.h" ascii wide nocase
        $h20 = "protonme" ascii wide nocase
        $h21 = "discordnitro" ascii wide nocase
        $h22 = "monero" ascii wide nocase
        $h23 = "rust" ascii wide nocase
        $h24 = "bitcoin" ascii wide nocase
        $h25 = "guardshield" ascii wide nocase
        ...
        $h31 = "destructive" ascii wide nocase
